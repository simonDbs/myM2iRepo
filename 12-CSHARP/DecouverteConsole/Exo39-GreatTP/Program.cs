namespace GreatTpFunction.CLasses
{
    public class Program
    {
        ...
        ////Functions
        ///Affichage
        static void AffichageMessage(int choixmenu)
        {
        ...
        static void AffichageMessageError()
        {
            Console.Clear();
            Console.ForegroundColor = System.ConsoleColor.Red;
            Console.WriteLine("\tERREUR DE SAISIE");
        ...
        ///Action
        //static string boucleforlist(string table)
        //{
        //    int x = 0;  
